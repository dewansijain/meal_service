    ...
    <div className="px-5 py-10 lg:px-20" id='home'>
      <div className='flex flex-col lg:flex-row justify-between items-center gap-5 lg:gap-20'>
        <div className="flex flex-col gap-5 lg:gap-10 flex-1 order-2 lg:order-1">
          ...
          <a href='https://wa.me/message/C4VSUMVP2AIZC1' rel="noreferrer" target='_blank' className="bg-red-700 hover:scale-105 active:scale-95 text-white px-10 py-2 text-2xl self-center lg:self-start rounded-full">Order Now</a>
        </div>
