...
export default function WhyUs() {
  return (
    <div className="px-5 flex py-24 lg:px-20 bg-red-700 flex-col gap-12 items-center justify-center" id='why_us'>
      <h2 className='text-white text-4xl font-bold text-center'>
        Why Momimeals?
      </h2>
      <div className="flex flex-row flex-wrap gap-6 flex-1 justify-center items-stretch">
        <div className="flex flex-col gap-5 flex-1 bg-white p-7 rounded-semi-full items-center">
          <div className="flex flex-row gap-5 justify-center w-full items-center">
            ...
            <h3 className='font-bold text-red-700 text-2xl flex-1 text-center'>Our USP: Eat what you like!</h3>
          </div>
        ...
        <div className="flex flex-col gap-5 flex-1 bg-white p-7 rounded-semi-full items-center">
          <div className="flex flex-row gap-5 justify-center w-full items-center">
            ...
            <h3 className='font-bold text-red-700 text-2xl flex-1 text-center'>Use of Fresh Ingredients</h3>
          </div>
        ...
        <div className="flex flex-col gap-5 flex-1 bg-white p-7 rounded-semi-full items-center">
          <div className="flex flex-row gap-5 justify-center w-full items-center">
            ...
            <h3 className='font-bold text-red-700 text-2xl flex-1 text-center'>Hygiene & Packaging</h3>
          </div>
      ...
      <div className="flex flex-row flex-wrap gap-6 flex-1 justify-center items-stretch">
        <div className="flex flex-col gap-5 flex-1 bg-white p-7 rounded-semi-full items-center">
          <div className="flex flex-row gap-5 justify-center w-full items-center">
            ...
            <h3 className='font-bold text-red-700 text-2xl flex-1 text-center'>Easy Ordering Process</h3>
          </div>
        ...
        <div className="flex flex-col gap-5 flex-1 bg-white p-7 rounded-semi-full items-center">
          <div className="flex flex-row gap-5 justify-center w-full items-center">
            ...
            <h3 className='font-bold text-red-700 text-2xl flex-1 text-center'>Personalized Support </h3>
          </div>
        ...
        <div className="flex flex-col gap-5 flex-1 bg-white p-7 rounded-semi-full items-center">
          <div className="flex flex-row gap-5 justify-center w-full items-center">
            ...
            <h3 className='font-bold text-red-700 text-2xl flex-1 text-center'>Timely Delivery</h3>
          </div>
