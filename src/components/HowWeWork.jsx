  ...
  return (
    <div className="px-5 flex py-24 lg:px-20 bg-white flex-col gap-12 items-center justify-center" id='work'>
      ...
      <div className="flex flex-row gap-3 flex-1">
        <div className={`flex flex-col items-center justify-center w-40 h-40 gap-5 ${style.image1}`}>
          <p className='text-center text-xs p-8'>
      ...
      <button className="bg-red-700 text-white px-10 py-2 text-2xl self-center rounded-full">Order Now</button>
    </div>
  )
}
