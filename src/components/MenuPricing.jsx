		...
		<div className="px-5 py-10 lg:px-20 bg-red-700 flex flex-col lg:flex-row gap-10" id='menu'>
			...
			<div className='flex p-10 flex-1 bg-white rounded-lg flex-col justify-between items-center gap-2'>
				...
				<div className="flex flex-row flex-wrap gap-6 flex-1 justify-center items-center">
					...
					<div className="flex flex-col w-5/12 p-3 bg-red-700 rounded-lg items-center justify-center cursor-pointer hover:scale-105 active:scale-95" onClick={() => handleClick(1)}>
						<h3 className="text-sm lg:text-xl font-bold text-white">Tuesday</h3>
					</div>
					<div className="flex flex-col w-5/12 p-3 bg-red-700 rounded-lg items-center justify-center cursor-pointer hover:scale-105 active:scale-95" onClick={() => handleClick(2)}>
						<h3 className="text-sm lg:text-xl font-bold text-white">Wednesday</h3>
					</div>
					<div className="flex flex-col w-5/12 p-3 bg-red-700 rounded-lg items-center justify-center cursor-pointer hover:scale-105 active:scale-95" onClick={() => handleClick(3)}>
						<h3 className="text-sm lg:text-xl font-bold text-white">Thursday</h3>
					</div>
					<div className="flex flex-col w-5/12 p-3 bg-red-700 rounded-lg items-center justify-center cursor-pointer hover:scale-105 active:scale-95" onClick={() => handleClick(4)}>
						<h3 className="text-sm lg:text-xl font-bold text-white">Friday</h3>
					</div>
					<div className="flex flex-col w-5/12 p-3 bg-red-700 rounded-lg items-center justify-center cursor-pointer hover:scale-105 active:scale-95" onClick={() => handleClick(5)}>
						<h3 className="text-sm lg:text-xl font-bold text-white">Saturday</h3>
					</div>
					<div className="flex flex-col w-5/12 p-3 bg-red-700 rounded-lg items-center justify-center cursor-pointer hover:scale-105 active:scale-95" onClick={() => handleClick(6)}>
					...
					<div className="flex flex-col gap-5 flex-1 bg-white p-5 rounded-lg justify-center items-center">
						...
						<div className="flex flex-col gap-2">
							<div className="flex w-full flex-col gap-2 border-dashed border-b-2 pb-2 border-red-700 items-center">
								...
								<p className="text-lg">Both lunch & dinner delivered to you</p>
							</div>
							<div className="flex w-full flex-row justify-between gap-2 border-dashed border-b-2 pb-2 border-red-700 items-center">
								<div className="flex flex-col gap-1">
									<p className='text-red-700 font-bold'>3 Days</p>
